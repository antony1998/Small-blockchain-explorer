    ...
    if(this.state.data.result == undefined) {
      return (<div>
        <form action="/action_page.php">
          address: <TextField id="address" type="address" label="address" className={classes.textField} value={this.state.address} onChange={this.handleChange('address')} margin="normal"/><br/>
    ...
    return (
      <div>
        <form action="/action_page.php">
          ...
          <button type="button" className="btn btn-info"  onClick={()=> this.getData()} >Search</button>
          <button type="button" className="btn btn-success"  onClick={()=> this.saveData()} >Save</button>
          <div>Balance: {this.state.balance}</div>
        </form>
